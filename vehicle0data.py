...
parser.add_argument("-t", "--topic", action="store", dest="topic", default="data/vehicle0", help="Targeted topic")
...
while True:
    if args.mode == 'both' or args.mode == 'publish':
        message = {'message': ""}
        with open("vehicle0.csv", 'r') as read_obj:
            ...
            for row in csv_reader:
                ...
                myAWSIoTMQTTClient.publish("data/emission", messageJson, 0)
