...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint("a21311smztdyl2-ats.iot.us-east-1.amazonaws.com", 8883)
    ...
    def publish(self, Payload="it works!"):
        #TODO4: fill in this function for your publish
        self.client.subscribeAsync("myThings/topic", 0, ackCallback=self.customSubackCallback)
        
        self.client.publishAsync("myThings/topic", Payload, 0, ackCallback=self.customPubackCallback)
